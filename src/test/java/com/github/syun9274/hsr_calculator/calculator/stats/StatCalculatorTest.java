package com.github.syun9274.hsr_calculator.calculator.stats;

import com.github.syun9274.hsr_calculator.calculator.StatCalculator;
...
class StatCalculatorTest {
    ...
    void calculateFinalAtk_OnlyFlatBuffs() {
        ...
        List<Buff> buffs = Arrays.asList(
                ...
                // 기본 행적 버프 (제거 불가)
                new Buff(BuffType.ATK_PERCENT, 4),
                new Buff(BuffType.ATK_PERCENT, 4),
                new Buff(BuffType.ATK_PERCENT, 6),
                new Buff(BuffType.ATK_PERCENT, 6),
                new Buff(BuffType.ATK_PERCENT, 8)
        );
    ...
    void calculateFinalAtk_MixedBuffs() {
        ...
        List<Buff> buffs = Arrays.asList(
                ...
                new Buff(BuffType.ATK_PERCENT, 8.6),
                new Buff(BuffType.ATK_PERCENT, 43.2),
                // 기본 행적 버프 (제거 불가)
                new Buff(BuffType.ATK_PERCENT, 4),
                new Buff(BuffType.ATK_PERCENT, 4),
                new Buff(BuffType.ATK_PERCENT, 6),
