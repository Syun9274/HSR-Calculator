...
public class DmgMultiplier {
     ...
     */
    private double getDmgMultiplier(Element characterElement, List<Buff> buffs, BuffType specificDamageType) {
        // 원소별 피해 증가
        BuffType elementalBoost = getElementalDamageBoost(characterElement);
        return 1 + MathUtil.sumPercentBuffs(buffs, BuffType.DAMAGE_BOOST, elementalBoost, specificDamageType);
    }
     ...
     * @return 피해 증가 수치 합연산
     */
    public double getBasicAttackDmgMultiplier(Element characterElement, List<Buff> buffs) {
        return getDmgMultiplier(characterElement, buffs, BuffType.BASIC_ATTACK_DAMAGE_BOOST);
    }
     ...
     * @return 피해 증가 수치 합연산
     */
    public double getSkillDmgMultiplier(Element characterElement, List<Buff> buffs) {
        return getDmgMultiplier(characterElement, buffs, BuffType.SKILL_DAMAGE_BOOST);
    }
     ...
     * @return 피해 증가 수치 합연산
     */
    public double getUltimateDmgMultiplier(Element characterElement, List<Buff> buffs) {
        return getDmgMultiplier(characterElement, buffs, BuffType.ULTIMATE_DAMAGE_BOOST);
    }
